...
const CreatePurchase = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.items.some((i) => !i.productId || i.quantity <= 0))
      return toast.error("All items must have a product selected");
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <SearchableSelect
                ...
                onCreate={(name) => {
                  setVendorModalData({ ...vendorModalData, name });
                  setShowVendorModal(true);
                }}
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-4">
            {formData.items.map((item, index) => (
              <div
                key={index}
                className="flex flex-col md:flex-row gap-4 items-end bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg"
              >
                <div className="flex-1 min-w-[200px]">
                  <label className="block text-xs font-medium text-gray-500 mb-1">
                    Product{" "}
                    {item._scannedName && !item.productId && (
                      <span className="text-orange-500 ml-1">
                        (Scanned: {item._scannedName})
                      </span>
                    )}
                  </label>
                  <SearchableSelect
                    ...
                    displayKey="name"
                    valueKey="_id"
                    renderOption={(p) => `${p.name} (Stk: ${p.currentStock})`}
                  />
                </div>
                <div className="w-24">
                  <label className="block text-xs font-medium text-gray-500 mb-1">
                ...
                <button
                  ...
                  className="p-2 text-red-500 hover:bg-red-50 rounded-lg pb-2"
                >
        ...
        <div className="flex justify-end">
          <div className="w-full md:w-1/3 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 space-y-3">
            ...
            <button
              type="submit"
              className="w-full mt-4 flex justify-center items-center py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 font-semibold shadow-lg shadow-indigo-500/30 transition-all"
            >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                This vendor was not found in your database. Would you like to
                add it?
              </p>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white bg-gray-50"
                  value={vendorModalData.gstin}
                  onChange={(e) =>
                    setVendorModalData({
                      ...vendorModalData,
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={!vendorModalData.name.trim()}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-700">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                ...
                Unknown Product ({currentPendingIndex + 1}/
            ...
            <div className="p-6 space-y-4">
              <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg border border-orange-100 dark:border-orange-900/30">
                <p className="text-sm text-orange-700 dark:text-orange-300">
                  ...
                  {pendingProducts[currentPendingIndex]?.name}"
                </p>
                <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">
                  This product was not found in your database. You can add it as
                  new or map it to an existing product.
                </p>
              </div>
              ...
              <div>
                ...
                <select
                  className="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                  onChange={(e) => {
                    if (e.target.value) handleMapToExisting(e.target.value);
                  }}
                  defaultValue=""
                >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    className="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    value={productModalData.taxRate}
                    onChange={(e) =>
                      setProductModalData({
                        ...productModalData,
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    value={productModalData.hsnCode}
                    onChange={(e) =>
                      setProductModalData({
                        ...productModalData,
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={!productModalData.name.trim()}
