...
import { Sun, Moon, Bell, User, LogOut, ChevronDown, Plus, FileText, ShoppingCart, ClipboardList, Package, Building2, Receipt } from 'lucide-react';
        ...
        <header className="sticky top-0 z-40 h-16 flex items-center justify-between px-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700/50">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative">
                    <button
                        onClick={() => setDropdownOpen(dropdownOpen === 'create' ? false : 'create')}
                    ...
                    >
                        ...
                        <span>Create</span>
                        <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${dropdownOpen === 'create' ? 'rotate-180' : ''}`} />
                    </button>
                    ...
                    {dropdownOpen === 'create' && (
                        <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 py-2 z-50 animate-in fade-in slide-in-from-top-2">
                            ...
                            <Link to="/create-invoice" onClick={() => setDropdownOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <FileText className="w-4 h-4 text-blue-500" /> Create Invoice
                            </Link>
                            <Link to="/create-purchase" onClick={() => setDropdownOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <ShoppingCart className="w-4 h-4 text-purple-500" /> Create Purchase
                            </Link>
                            <Link to="/create-quotation" onClick={() => setDropdownOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <ClipboardList className="w-4 h-4 text-amber-500" /> Create Quotation
                            </Link>
                            ...
                            <div className="grid grid-cols-2 gap-1 px-2">
                                <Link to="/products" onClick={() => setDropdownOpen(false)} className="flex flex-col items-center justify-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 text-center">
                                ...
                                <Link to="/customers" onClick={() => setDropdownOpen(false)} className="flex flex-col items-center justify-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 text-center">
                                    <div className="p-2 bg-green-50 dark:bg-green-900/20 rounded-lg mb-1">
                                        <User className="w-4 h-4 text-green-600 dark:text-green-400" />
                                    </div>
                                    <span className="text-xs text-gray-600 dark:text-gray-300">Customer</span>
                                </Link>
                                <Link to="/vendors" onClick={() => setDropdownOpen(false)} className="flex flex-col items-center justify-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 text-center">
                                    ...
                                    <span className="text-xs text-gray-600 dark:text-gray-300">Vendor</span>
                                </Link>
                                <Link to="/expenses" onClick={() => setDropdownOpen(false)} className="flex flex-col items-center justify-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 text-center">
                                    <div className="p-2 bg-red-50 dark:bg-red-900/20 rounded-lg mb-1">
                                        <Receipt className="w-4 h-4 text-red-600 dark:text-red-400" />
                                    </div>
                                    <span className="text-xs text-gray-600 dark:text-gray-300">Expense</span>
                                </Link>
                            </div>
                        </div>
                    )}
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <div className="hidden sm:block text-left">
                            <p className="text-sm font-medium text-gray-800 dark:text-gray-200 leading-tight">{user?.name || 'Admin'}</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400 leading-tight">{user?.isAdmin ? 'Super Admin' : 'User'}</p>
                        </div>
                        <ChevronDown className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${dropdownOpen === 'profile' ? 'rotate-180' : ''}`} />
                    </button>
