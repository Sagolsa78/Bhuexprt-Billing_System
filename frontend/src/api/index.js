...
export const paymentAPI = {
  getAll: () => api.get("/payments"), // Payment controller not paginated yet, skipping for now as not requested in plan specifically, but good to have. Sticking to plan.
...
export const reportAPI = {
  sendReminder: (data) =>
    api.post(`/reports/send-reminder/${data._id || data.id}`, data),
...
export const vendorAPI = {
  ...
  verifyGST: (gstin) => api.post("/vendors/verify-gst", { gstin }),
};
